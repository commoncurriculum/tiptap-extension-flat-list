...
describe("postprocessor plugin", () => {
  ...
  function setupList(
    ...
    listType:
      ...
      | "flatListItemTask" = "flatListItemOrdered",
  ) {
  ...
  describe("counters", () => {
    it("numbers consecutive ordered items", () => {
      ...
      assert.deepStrictEqual(summarize(editor), [
        ...
        { type: "flatListItemOrdered", text: "c", indent: 0, counter: 3 },
      ]);
    });
    ...
    it("numbers each indent level separately", () => {
      ...
      assert.deepStrictEqual(summarize(editor), [
        ...
        { type: "flatListItemOrdered", text: "c", indent: 1, counter: 2 },
        { type: "flatListItemOrdered", text: "d", indent: 0, counter: 2 },
      ]);
    });
    ...
    it("restarts a nested counter after returning to the outer level", () => {
      ...
      assert.deepStrictEqual(summarize(editor), [
        ...
        { type: "flatListItemOrdered", text: "b", indent: 1, counter: 1 },
        { type: "flatListItemOrdered", text: "c", indent: 0, counter: 2 },
        { type: "flatListItemOrdered", text: "d", indent: 1, counter: 1 },
        { type: "flatListItemOrdered", text: "e", indent: 0, counter: 3 },
      ]);
    });
    ...
    it("restarts the counter after a non-list block", () => {
      ...
      assert.deepStrictEqual(summarize(editor), [
        ...
        { type: "flatListItemOrdered", text: "c", indent: 0, counter: 1 },
      ]);
    });
    ...
    it("restarts the counter after an item of another list type", () => {
      setupList(3);
      setCursorIn(editor, 1);
      editor.commands.setFlatListItem("flatListItemUnordered");
      assert.deepStrictEqual(summarize(editor), [
        { type: "flatListItemOrdered", text: "a", indent: 0, counter: 1 },
        { type: "flatListItemUnordered", text: "b", indent: 0 },
        { type: "flatListItemOrdered", text: "c", indent: 0, counter: 1 },
      ]);
    });
  });
  ...
  describe("indent / dedent commands", () => {
    it("refuses to indent the first item of a list", () => {
      setupList(2, "flatListItemUnordered");
      setCursorIn(editor, 0);
    ...
    it("refuses to indent more than one past the previous item", () => {
      setupList(3, "flatListItemUnordered");
      setCursorIn(editor, 1);
    ...
    it("dedents descendants along with the dedented item", () => {
      setupList(4, "flatListItemUnordered");
      // a(0), b(1), c(2), d(1).
      setCursorIn(editor, 1);
      editor.commands.indentFlatListItem();
      ...
      assert.deepStrictEqual(summarize(editor), [
        { type: "flatListItemUnordered", text: "a", indent: 0 },
        { type: "flatListItemUnordered", text: "b", indent: 0 },
        { type: "flatListItemUnordered", text: "c", indent: 1 },
        { type: "flatListItemUnordered", text: "d", indent: 1 },
      ]);
    });
    ...
    it("preserves indent when switching list type", () => {
      ...
      setCursorIn(editor, 1);
      editor.commands.indentFlatListItem();
      editor.commands.setFlatListItem("flatListItemOrdered");
  ...
  describe("indent repair", () => {
    ...
    it("shifts descendants along with a clamped item", () => {
      setupList(5, "flatListItemUnordered");
      ...
      assert.deepStrictEqual(summarize(editor), [
        { type: "flatListItemUnordered", text: "a", indent: 0 },
        { type: "flatListItemUnordered", text: "b", indent: 1 },
        { type: "flatListItemUnordered", text: "c", indent: 2 },
        { type: "flatListItemUnordered", text: "d", indent: 1 },
        { type: "flatListItemUnordered", text: "e", indent: 2 },
      ]);
    });
    ...
    it("stops shifting after the clamped item's descendants", () => {
      ...
      assert.deepStrictEqual(summarize(editor), [
        ...
        { type: "flatListItemUnordered", text: "b", indent: 1 },
        { type: "flatListItemUnordered", text: "c", indent: 2 },
        { type: "flatListItemUnordered", text: "d", indent: 2 },
      ]);
    });
    ...
    it("leaves valid indents alone", () => {
      ...
      assert.deepStrictEqual(summarize(editor), [
        ...
        { type: "flatListItemUnordered", text: "b", indent: 1 },
        { type: "flatListItemUnordered", text: "c", indent: 2 },
        { type: "flatListItemUnordered", text: "d", indent: 0 },
      ]);
    });
